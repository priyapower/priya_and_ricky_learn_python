...
- Goal is to build a Space Shooter game while learn Arcade and Pygame
...
## Priya's Practice
Goal is to build a Space Shooter game while learn Arcade
- [Part 0: Arcade, Pygame, and Crafting Game Code](#part-0)
  1. [Getting to Know Arcade and Pygame](#Getting-to-Know-Arcade-and-Pygame)
...
- [Part 1: Initial Setup](#part-1)
  ...
  1. [Install PyCharm](#Install-PyCharm)
  1. [Install Arcade](#Install-Arcade)
- [Part 2: Getting to Know Arcade](#part-2)
  1. [Building a Basic Arcade Program](#Building-a-Basic-Arcade-Program)
  1. [Initialization](#Initialization)
  1. [Windows and Coordinates](#Windows-and-Coordinates)
  1. [Drawing](#Drawing)
  1. [Object-Oriented Design](#Object-Oriented-Design)
  1. [Game Loop](#Game-Loop)
- [Part 3: Building the Game](#part-3)
  1. [Fundamental Concepts for Game](#Fundamental-Concepts-for-Game)
  1. [Imports and Constants](#Imports-and-Constants)
  1. [Window Class](#Window-Class)
  1. [Sprites and Sprite Lists](#Sprites-and-Sprite-Lists)
  1. [Scheduling Functions](#Scheduling-Functions)
  1. [Adding Enemies](#Adding-Enemies)
  1. [Moving Sprites](#Moving-Sprites)
  1. [Removing Sprites](#Removing-Sprites)
  1. [Adding Clouds](#Adding-Clouds)
  1. [Keyboard Input](#Keyboard-Input)
  1. [Updating the Game Objects](#Updating-the-Game-Objects)
  1. [Drawing on the Window](#Drawing-on-the-Window)
  1. [Collision Detection](#Collision-Detection)
- [Part 4: Adding Fun](#part-4)
  1. [Sound](#Sound)
  1. [Python Game Speed](#Python-Game-Speed)
  1. [Tweaks and Enhancements](#Tweaks-and-Enhancements)

------
### Part 0
------
#### Getting to Know Arcade and Pygame
[Top](#priyas-practice)
...
- A (very) brief intro to Game Design
...
### Part 2
------
#### Building a Basic Arcade Program
[Top](#priyas-practice)
