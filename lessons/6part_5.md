...
- So I run `09_endgame.py`. I see:
  ...
  - If I make it all the way to the end of the map (right most part), I am automatically sent to a another level
...
- Upgrades to come:
  ...
  1. Level counter
  1. Coins left displayed on the score section
...
[Top](#priyas-practice)
- There are so many potential updates to make to the game at this point (see [above](#round-1-game-cleanup-and-annotations))
- Let's start with adding ladders, animated tiles, and moving platforms
...
#### Round 2 Game Cleanup And Annotations
[Top](#priyas-practice)
- sdlkjf
